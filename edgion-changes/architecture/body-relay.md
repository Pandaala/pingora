...
Pingora v4 commits `4bf5ff6` and `3ab9dbe` contain the reorganized generic
phase 1-4 relay and response-head barrier mechanisms. Edgion `feature-08-30`
at `f31d0169da97` contains the production consumer integration; its historical
validation selected v3 commit `af9e1ac057c6` from the fork's `edgion_v3` git
source. The configuration-to-wire regression coverage
