...
- Reorganized stack: `edgion_v4`, rebuilt from the final `edgion_v3` net
  behavior at `dba39b6` on the unchanged `09696b5` base. Its functional stack
  begins with `d25eb4d` and ends with `3ab9dbe` before maintenance knowledge.
- The original `edgion`, `edgion_v2`, and `edgion_v3` refs are historical
  evidence; do not rewrite them while maintaining the current fork.
