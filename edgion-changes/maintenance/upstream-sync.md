...
- `edgion_v4` is the reorganized candidate branch built from the final v3 net
  behavior. It is not published or consumer-facing until its own verification,
  immutable tag, explicit publication authorization, and consumer cutover are
  complete.
